<%
	...
	session.setAttribute("userbarcode", null);
%>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@page import="ru.defo.util.AppUtil"%>
<%@page import="ru.defo.servlets.Login"%>
...
<form id="loginform" action="<%=request.getContextPath() %>/Login" method="post" onclick="scanf(); init();">
<br>
<h2>ТСД "Дэфо"</h2>
<br>
