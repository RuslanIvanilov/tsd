<% if(session.getAttribute("oldbrowser") != null) {%>
 <jsp:forward page="enter_qty1.jsp"/>
<% } %>
<% System.out.println("enter_qty.jsp v2"); %>
...
<body>
<form style="zoom:200%" action="EnterQty" method="post">
<br>
...
<input style="display: inline; float: inherit; height: 52px; width: 230px;" type="button" id="btnCancel" value="Назад" onclick='document.location.href ="InvBinFrnQnt"'>
</div>
</form>
</body>
</html>