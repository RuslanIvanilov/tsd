...
<% if(session.getAttribute("oldbrowser") != null) {%>
 <jsp:forward page="advice_article1.jsp"/>
<% } %>
<% System.out.println("advice_article.jsp"); %>
...
<input style="display: inline; float: inherit; height: 52px; width: 70px;" type="button" id="btnOk" value="Назад" onclick=" location.href='${backpage}'">
<input style="display: inline; float: inherit; height: 52px; width: 70px;" type="button" id="btnArtList" value="Товары" onclick=" location.href='${artlist}'">
<input style="display: inline; float: inherit; height: 52px; width: 70px;" type="button" id="btnPrintArticle" value="Печать" onclick=" location.href='${printpage}'">
</div>
</form>
</body>
</html>