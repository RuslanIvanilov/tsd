<% System.out.println("control_start.jsp");%>
...
<p>
Сканируйте штрих-код <u>Поддона</u> для контроля
</p>

<input class="wminput" type="text" id="scanedtext" name="scanedtext" onkeypress="if (event.keyCode == 13) submit">
<div class="div">
