<% if(session.getAttribute("oldbrowser") != null) {%>
 <jsp:forward page="enter_leveln1.jsp"/>
<% } %>
<% System.out.println("enter_levelN.jsp"); %>
...
<input type="text" id="enteredtext" name="enteredtext" onkeyup = "this.value=parseInt(this.value) |''"> <!-- onkeydown="submit"> -->
