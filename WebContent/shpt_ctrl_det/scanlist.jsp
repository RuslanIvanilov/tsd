...
<body>
	<form class="<%=session.getAttribute("oldbrowser") != null?"ce":"wm" %>form"
		...
		method="post">
		<p><b><small>С поддона <%=session.getAttribute("unitcode") %></small></b></p>
				    ...
				    if(session.getAttribute("actiondel")==null){
				 	    ...
				 	    for(Vorderpos quantInfo :quantList){
				 	      	...
				 	      	if(scanqty != null){
								...
								Long balanceQty = (Long.decode(scanqty)+(quantInfo.getFactQuantity()==null?0:quantInfo.getFactQuantity()))-quantInfo.getExpectQuantity();
