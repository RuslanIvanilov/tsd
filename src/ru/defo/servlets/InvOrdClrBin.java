...
/**
 * Servlet implementation class InvOrdClrBin
 */
@WebServlet("/InvOrdClrBin")
public class InvOrdClrBin extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		{
			//new UnitController().delUnitFromBin(session, unitBarcode, userIdo, commentText);
			String err = new InventoryController().setBinClear(session);
