 ...
 */
@WebServlet("/gui/ArticleQtyList")
public class ArticleQtyList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/gui/article_qty_list.jsp").forward(request, response);
		return;
	}
