...
public class PickList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		session.setAttribute("qsflt", AppUtil.getReqSessionAttribute(request, session, "qsflt", "", false));
		...
		request.getRequestDispatcher("/gui/pick_list.jsp").forward(request, response);
		return;
	}
