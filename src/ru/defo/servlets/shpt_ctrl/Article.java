...
public class Article extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if(request.getParameter("scaned_art_text") != null && !request.getParameter("scaned_art_text").trim().isEmpty())
		{
			...
			int ctrlQtyByOrder = new OrderPosManager().getControlQtyByOrderPosList(orderPos);
			if(expQtyByOrder<(ctrlQtyByOrder+Integer.decode(vol))){
