...
public class AdvicePosFilter {
	...
	public AdvicePosFilter(){
		super();
	}

	public AdvicePosFilter(Long adviceId, String posflt, String articleidflt, String artdescrflt, String skuflt,
